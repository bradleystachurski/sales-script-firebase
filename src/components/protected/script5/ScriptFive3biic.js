...
class ScriptFive3biic extends Component {
  render() {
    return (
      <div className="script-container">
        ...
        <p><strong>You:</strong> (Ask when they will have the campaign setup, and schedule follow up for me to do the audit/review)</p>
...
export default ScriptFive3biic
